...
async function generateImageForSouvenir(souvenir) {
  ...
  const endpoint = 'projects/' + PROJECT_ID + '/locations/' + LOCATION + '/publishers/google/models/' + MODEL_ID;
    ...
    const customPrompts = {
      ...
      "바나나맛 우유": "high resolution photo of pastel yellow beverage in an opaque plastic container, cylindrical design wider in the middle than top/bottom (hexagonal when viewed from side), studio quality, 400x400, clear background, product photography",
      ...
      "스티커": "high resolution photo of cute Joseon Royal Guard character stickers, fan merchandise, vibrant colors, pop culture aesthetic, idol related, studio quality, 400x400, clear background, product photography",

      "도장": "high resolution photo of a cylindrical traditional Korean stamp with mother-of-pearl design, Korean characters '제시카인' (Jessica In) engraved on the bottom surface, in a traditional Korean setting, handcrafted, intricate details, cultural significance, studio quality, 400x400, clear background",
      ...
      "제기": "high resolution photo of a traditional Korean jegi shuttlecock toy used in Jegichagi game, in a traditional Korean setting, handcrafted, intricate details, cultural significance, studio quality, 400x400, clear background",

      "윷놀이 세트": "high resolution photo of a Yut Nori game set, including four yut sticks and a yut board, traditional Korean board game, in a traditional Korean setting, handcrafted, intricate details, cultural significance, studio quality, 400x400, clear background",

      "공기놀이": "high resolution photo of five traditional Korean gonggi stones (gonggi-al) used in the Gonggi Nori game, in a traditional Korean setting, handcrafted, intricate details, cultural significance, studio quality, 400x400, clear background",

      "한글 디자인 상품": "high resolution photo of a traditional Korean square lantern with subtle Hangeul script design, in a traditional Korean setting, handcrafted, intricate details, cultural significance, studio quality, 400x400, clear background",
      ...
      "아이돌 앨범": "high resolution photo of a fictional K-POP boy group's third album, album cover art, fan merchandise, vibrant colors, pop culture aesthetic, studio quality, 400x400, clear background, product photography",

      "포토카드": "high resolution photo of a fictional K-POP boy group photo card, credit card size, fan merchandise, vibrant colors, pop culture aesthetic, studio quality, 400x400, clear background, product photography",

      "연예인 화보집": "high resolution photo of a lovely photobook of a fictional lead Korean actress, studio quality, 400x400, clear background, product photography",
